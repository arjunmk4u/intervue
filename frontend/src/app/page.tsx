    ...
    <main className="min-h-screen bg-[#f4f8fb] text-slate-800 font-sans overflow-x-hidden relative">
      ...
      <nav className="relative z-20 flex items-center justify-between px-8 py-5 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-full text-sm font-bold text-white bg-[#4a8394] hover:bg-[#3d6c7a] shadow-[0_4px_14px_0_rgba(74,131,148,0.35)] hover:shadow-[0_6px_20px_rgba(74,131,148,0.3)] transition-all"
          >
            Start Interview →
          </button>
        </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 pt-16 pb-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={() => router.push('/setup')}
            className="group px-8 py-4 rounded-2xl text-base font-bold text-white bg-[#4a8394] hover:bg-[#3d6c7a] shadow-[0_8px_30px_rgba(74,131,148,0.4)] hover:shadow-[0_12px_40px_rgba(74,131,148,0.5)] transition-all duration-300 flex items-center gap-2"
          >
            Start Free Interview
            <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
          </button>
          <a href="#how-it-works" className="px-8 py-4 rounded-2xl text-base font-bold text-slate-700 bg-white border border-slate-200 hover:border-[#72abad] hover:bg-[#f4f8fb] transition-all duration-300">
            See how it works
          </a>
        </div>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:shadow-md hover:border-[#72abad]/40 transition-all duration-300 group">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-[#cdebe7] to-[#72abad] flex items-center justify-center mb-6 shadow-[0_4px_12px_rgba(114,171,173,0.3)] group-hover:scale-110 transition-transform">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 py-24 text-center">
        <div className="bg-white border border-slate-200 rounded-[2.5rem] p-12 shadow-[0_20px_60px_rgba(74,131,148,0.12)] relative overflow-hidden">
          ...
          <button
            onClick={() => router.push('/setup')}
            className="group px-10 py-4 rounded-2xl text-base font-bold text-white bg-[#4a8394] hover:bg-[#3d6c7a] shadow-[0_8px_30px_rgba(74,131,148,0.4)] hover:shadow-[0_12px_40px_rgba(74,131,148,0.5)] transition-all duration-300 inline-flex items-center gap-2"
          >
